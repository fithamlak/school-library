...
describe Rental do
  ...
  describe '#initialize' do
    it 'should create a new rental with the given date, book_id and person_id' do
      rental = described_class.new('2023-02-01', book.id, person.id)

      expect(rental.date).to eq('2023-02-01')
    ...
    it 'should add the rental to the list of all rentals' do
      rental = described_class.new('2023-02-01', book.id, person.id)
  ...
  describe '.all' do
    it 'returns the list of all rentals' do
      rental1 = described_class.new('2023-02-01', book.id, person.id)
      rental2 = described_class.new('20223-02-02', book.id, person.id)
